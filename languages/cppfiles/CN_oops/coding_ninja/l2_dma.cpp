...
/*
stack or heap memory hoti hai jab b allocate krte hai stack kam nd heap jyada jb prgrm run then stack mmeorynle kr start    int i sbka data memory stack me allocatehoti hai 
...
8 bytes for pntr nd 4 bytes for integer
