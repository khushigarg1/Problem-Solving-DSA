...
#include<algorithm>
using namespace std;
// same access pr rho ya kam jane pr koshish then no issue but jyada access pr jane ki koshish then more issues issues
void g(int const &a){
    // a++;   cannot do this
}
...
int main(){
    ...
    // now we can do this a constant integer can store to constant pointer
