...
lets imagine 
we need 20 students and their properties are roll no, name , age 
if we want to create 20 students then we should have three all properteis to every student 
roll number , name , age
same explanantion sb stduenst ko deni pdegi isk aps ye ye nd all
...
OOPS -> class is a blueprint thaht defines all properties of our objects and all
     -> objects 
*/
