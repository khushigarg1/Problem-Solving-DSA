...
int main(){
    int a[10];
    cout<<a<<endl;
    cout<<&a[0]<<endl;  //pointer and arrays are mostly same only diff is that pointers allocates 8 butes memory separately and array does not array stores 40 bytes memory i/e/ 10 * 4 = 40 every integer is of 4 butes so 10 integers will  be of 40 bytes 
