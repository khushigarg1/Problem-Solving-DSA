...
public:
    ...
    void DiceRoll()
    {
        ...
        {
            cout << endl
                 << "you rolled 6 you will roll again" << endl;
            DiceRoll();
        }
...
void SnakeorLadder(int &num)
{
    ...
    {
        cout << endl
             << "you found a ladder and you position increased by " << ladder[num - 1] << " places" << endl;
    }
    else if (ladder[num - 1] < 0)
    {
        cout << endl
             << "you found a snake and you position decreased by " << ladder[num - 1] << " places" << endl;
    }
