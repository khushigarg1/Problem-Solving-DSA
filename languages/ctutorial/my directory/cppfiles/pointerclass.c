...
//---->>arr pointer
{
   ...
   printf("%d",sizeof(arr));    //40     arr aayga 40 bcoz 10 variables 4 bytes store 
   printf("%d",arr);             //536       base address aayga
   printf("%d",&arr);           // 536    base adress symbol table m se aa rahi h
