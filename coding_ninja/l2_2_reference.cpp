...
void increment(int &n){
    n++;        // it means thhat this n is also points to i of main fxn thaht is reference to i
}
...
/*
we can make var jinka khudka space nh hoga kisi or k memory space ko they will accessek ko change then dusre me reflect 
USE fxn me bhejne k 2 bennefit hai 
frst dono same memory ko use kr rhe hai ek change then other will also change
second ref k through we r sending so hume copy nh bnani pdh rhi new storage ki no need
