...
int main(){
    ...
    int c = a>b ? a : b;    // it is not a good code bcoz we have to stop every second ki yekrta kya hia yadi a b s ebda then ye nd then vo
    int x, y;
    x = 12;
    y = 13;
    int z = a> b ? a : b;
    ...
    // we canot do use of inline fxn bcoz if we copy evry where then ouput file will become bulky inlinemeans only we r giving hint to the compiler its uski wish
